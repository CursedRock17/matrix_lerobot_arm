"""Record a block-pick-up teleop dataset for SmolVLA fine-tuning.
...
init_rerun(session_name="smolvla_record")
...
try:
    ...
    while episode < NUM_EPISODES and not events["stop_recording"]:
        ...
        # Start recording our episode at a given FPS for a given EPISODE_TIME
        record_loop(
            robot=follower,
            events=events,
            fps=FPS,
        ...
        # Reset the episodes for a couple seconds
        ...
        # Add our episode to the dataset
...
# Send the finished dataset to the hub
